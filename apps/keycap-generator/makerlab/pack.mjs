...
// (the host config) into makerlab/keycap-legend-generator-mw.zip.
//
...
const appDir = join(import.meta.dirname, '..'); // apps/keycap-generator
const distDir = join(appDir, 'dist');
const configPath = join(appDir, 'makerlab', 'config.json');
const outZip = join(appDir, 'makerlab', 'keycap-legend-generator-mw.zip');
