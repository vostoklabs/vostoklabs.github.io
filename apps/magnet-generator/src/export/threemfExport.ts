...
export function buildThreeMF(parts: MagnetPart[]): Uint8Array {
  ...
  const metadata =
    ...
    `<metadata name="vl:application">Vostok Labs Magnet Generator</metadata>` +
