...
export const BBL_VERSION_META = '<metadata name="BambuStudio:3mfVersion">1</metadata>';
  ...
  return JSON.stringify(
    {
      version: '01.09.00.00',
      from: 'project',
      // Parallel arrays, 0-based by slot. Every one must be the same length or
      // Studio drops the lot and falls back to a single filament.
